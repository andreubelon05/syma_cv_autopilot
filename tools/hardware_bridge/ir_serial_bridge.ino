...
void loop() {
  ...
  // EL TRUC VISUAL: Si l'accelerador passa de la meitat, frenem el bucle
  if (Throttle > 64) {
    delay(500); // S'envia 2 cops per segon (pampallugueig molt lent i visible)
  } else {
    delay(20);  // S'envia 50 cops per segon (la llum sembla fixa)
  }
}